...
read -e -s -p "Enter the SSH private key for GitLab Credential: " GITLAB_SSH_KEY
echo "Result is: $GITLAB_SSH_KEY"
read -e -p "Enter tour GitLab URL default (https://gitlab.com): " GITLAB_URL
echo "Result is: $GITLAB_URL"
read -e -s -p "Enter the GitLab API Token: " GITLAB_API_TOKEN
echo "Result is: $GITLAB_API_TOKEN"
read -e  -p "Enter the GitLab email defaul (lab1@example.com): " GITLAB_EMAIL
echo "Result is: $GITLAB_EMAIL"
read -e  -p "Enter the GitLab user: " GITLAB_USER
echo "Result is: $GITLAB_USER"
read -e -s -p "Enter the Vault password: " VAULT_PASSWORD
echo "Result is: $VAULT_PASSWORD"
read -e -p "Enter the Controller dev host: " CONTROLLER_DEV_HOST
echo "Result is: $CONTROLLER_DEV_HOST"
read -e -p "Enter the Controller pro host: " CONTROLLER_PRO_HOST
echo "Result is: $CONTROLLER_PRO_HOST"
read -e  -p "Enter the username for controller user account: " CONTROLLER_USER_USERNAME
echo "Result is: $CONTROLLER_USER_USERNAME"
read -e -s -p "Enter the password for controller user account: " CONTROLLER_USER_PASSWORD
echo "Result is: $CONTROLLER_USER_PASSWORD"
read -e -p "Enter the email for controller user account: " CONTROLLER_USER_EMAIL
echo "Result is: $CONTROLLER_USER_EMAIL"
read -e -p "Enter the firstname for controller user account: " CONTROLLER_USER_FIRSTNAME
echo "Result is: $CONTROLLER_USER_FIRSTNAME"
read -e -p "Enter the lastname for controller user account: " CONTROLLER_USER_LASTNAME
echo "Result is: $CONTROLLER_USER_LASTNAME"
...
controller_user_accounts:
  - username: "${CONTROLLER_USER_USERNAME}"
    password: "${CONTROLLER_USER_PASSWORD}"
    email: "${CONTROLLER_USER_EMAIL}"
    firstname: "${CONTROLLER_USER_FIRSTNAME}"
    lastname: "${CONTROLLER_USER_LASTNAME}"
    is_auditor: False
    is_superuser: True
